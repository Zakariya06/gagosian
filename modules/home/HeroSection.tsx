...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-55px)] overflow-hidden">
      <h2 className="text-[50px] lg:text-[60px] font-bold leading-12 absolute left-0 top-0 z-10 p-4 md:p-8 md:py-6 lg:p-8 xl:pl-8 xl:pt-8 uppercase GagosianHeadline text-white tracking-[0.5px]  type-gh-lg">
        gagosian
      </h2>
      <Swiper
          ...
          <SwiperSlide key={slide.id}>
            <div className="relative flex items-center justify-center w-full h-full">
              ...
              <div className="relative z-10 text-center px-4 text-white">
                ...
                {slide.subtitle && (
                  <h3 className="text-[30px] md:text-[34px] mt-1 font-bold minion-pro-condensed type-gh-lg ">
                    {slide.subtitle}
                  </h3>
                )}
                <p className="md:text-lg text-base font-normal text-white GTAmerica -mt-1">
                  {slide.location}
                </p>

                <Link
                  href={slide.link}
                  className={`inline-block border border-transparent px-1.5 py-0.5 mt-6 text-lg duration-200  type-gh-lg transition-colors GTAmerica ${
                    slide.theme === "dark"
